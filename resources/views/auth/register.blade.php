...
@section('title','Sign Up - Catoutcaw')
            ...
            <div class="sign-up-container">
                <form  method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <input type="text" name="full-name" class="form-control @error('full-name') is-invalid @enderror" value="{{ old('full-name') }}" placeholder="Full Name * ">
                            @error('full-name')
                    ...
                    <div class="form-group">
                        <input type="text" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="Phone No ">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="terms-and-condition">
                        <input type="checkbox" name="terms-and-condition" value="1">
                        <p>I agree to the <a href="">Terms of Use</a> & <a href="">Privacy Policy</a></p>
                    </div>
